    ...
    axios.get('http://localhost:3000/animals')
        .then(res => {
            ...
            for (let animal of res.data) {
                ...
                // document.querySelector('body').appendChild(newP)  // this works too
            }
        })
}
...
const repeatMyParam = () => {
    axios.get('http://localhost:3000/repeat/name')
    .then(res =>{
        console.log(res.data)
...
// CODE HERE
const queryTest = () =>{
    axios.get(`http://localhost:3000/query-test?name=Alec`)
    // axios.get(`http://localhost:3000/query-test?name=James&lastName=hager`)
